    ...
    $(function() {
        ...
        setClickableTooltip('#t0', 'see <a style="color:#00accd" href="../Hiring/faq.html">FAQ </a>');
        ...
        setClickableTooltip(
                '#t4',
                'The amount charged to your account for each candidate that takes pre-Built Test through your account'
        );
        setClickableTooltip('#t5'," Webcam Proctoring allows you to take exam-hall like controls in an online test. See a live video feed/static images of a candidate as they appear for a test.")
        ...
        setClickableTooltip('#t13',"Create tests that include questions from your own as well as Arrivu's Question Banks")
        ...
        setClickableTooltip('#t15',"Conduct online certification exams on Arrivu to certify applicants on vocational or professional qualifications. Has essential features like certification branding, payment gateway integration to collect payments from applicants, customizable certificates etc")
        ...
        setClickableTooltip('#t17',"Integrate Arrivu's online assessments with your own application such as HRMS, LMS, Job portal using REST APIs.")
